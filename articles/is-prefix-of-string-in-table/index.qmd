...
The chart was then saved as PDF, and then I edited each PDF in
[Inkscape](https://inkscape.org/) and deleted the surrounding border,
cropped the canvas to fit the diagram, and then saved as SVG.

After saving each chart as SVG, I'd edit it in Vim and manually do some font
