...
string definitely does **not** prefix match any of our known strings). The
fastest negative match could be done in around 6 CPU cycles, which is pretty
quick. (Integer division, for example, takes about 90 cycles.)
...
A SIMD-friendly C structure called [`STRING_TABLE`](#STRING_TABLE) was derived.
It is optimized for up to 16 strings, ideally of length less than or equal to
16 characters.  The table is created from the set of known strings up-front; it
is sorted by length, ascending, and a unique character (with regards to other
characters at the same byte offset) is then extracted, along with its index.  A
16-byte character array, [`STRING_SLOT`](#STRING_SLOT), is used to capture the
unique characters.  A 16-element array of unsigned characters, `SLOT_INDEX`, is
used to capture the index.  Similarly, lengths are stored in the same fashion
via `SLOT_LENGTHS`. Finally, a 16-element array of `STRING_SLOTs` is used to
capture up to the first 16 bytes of each string in the set.
...
[![The STRING_TABLE Structure](StringTable.svg)](StringTable.svg){#fig-stringtable}
...
Match](StringTable-NegativeMatch-v3.svg)](StringTable-NegativeMatch-v3.svg)
...
[![Benchmark Overview](Benchmark-Overview-v2.svg)](Benchmark-Overview-v2.svg)
...
[![STRING_TABLE Diagram](StringTable.svg)](StringTable.svg)
...
[`CreateStringTableFromDelimitedString`](https://github.
com/tpn/tracer/blob/2018-04-18. 2/StringTable2/CreateStringTable. c#L471) and
[`CreateStringTableFromDelimitedEnvironmentVariable`](https://github.
com/tpn/tracer/blob/2018-04-18. 2/StringTable2/CreateStringTable. c#L595),
simply break down their input into a `STRING_ARRAY` representation first
before calling [`CreateStringTable`](https://github.
com/tpn/tracer/blob/2018-04-18. 2/StringTable2/CreateStringTable. c#L51).
...
[![Benchmark Release vs
PGO](Benchmark-Release-vs-PGO-v3.svg)](Benchmark-Release-vs-PGO-v3.svg)
...
[![Benchmark 1](Benchmark-01-v6.svg)](Benchmark-01-v6.svg)
...
[![Benchmark 2](Benchmark-02-v1.svg)](Benchmark-02-v1.svg)
...
[![Benchmark 3](Benchmark-03-v1.svg)](Benchmark-03-v1.svg)
...
[![Benchmark 4](Benchmark-04-v1.svg)](Benchmark-04-v1.svg)
...
[![Benchmark 5](Benchmark-05-v2.svg)](Benchmark-05-v2.svg)
...
[![Benchmark 6](Benchmark-06-v1.svg)](Benchmark-06-v1.svg)
...
[![Benchmark 7](Benchmark-07-v1.svg)](Benchmark-07-v1.svg)
...
[![Benchmark 8](Benchmark-08-v1.svg)](Benchmark-08-v1.svg)
...
[![Benchmark 09](Benchmark-09-v1.svg)](Benchmark-09-v1.svg)
...
[![Benchmark 10](Benchmark-10-v1.svg)](Benchmark-10-v1.svg)
...
[![Benchmark x64 1](Benchmark-x64-01-v1.svg)](Benchmark-x64-01-v1.svg)
...
[![Benchmark Negative Match](Benchmark-x64-02-Negative-v1.svg)](Benchmark-x64-02-Negative-v1.svg)
...
[![Benchmark Prefix Match](Benchmark-x64-02-v2.svg)](Benchmark-x64-02-v2.svg)
...
[![Benchmark x64 3](Benchmark-x64-03-v1.svg)](Benchmark-x64-03-v1.svg)
