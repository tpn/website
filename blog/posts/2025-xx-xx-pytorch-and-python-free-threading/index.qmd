...
https://github.com/tpn/website/blob/main/blog/posts/2025-xx-xx-pytorch-and-python-free-threading/wrk-analysis.ipynb).
...
1. Skipping weight initialization.

2. Adding profiling.

4. OpenAI's GPT-2 XL Model?
...
class GPT:
    ...
    def from_pretrained(
        ...
        """
        Load a GPT model from a pretrained model downloaded from
        HuggingFace.

        Arguments:

            model_name (str): Supplies the model name to use.
                For more information, see the docstring for
                `.util.get_huggingface_safetensors()`.

            map_location (str): Optionally supplies the device
                to map the loaded tensor parameters to.  If None,
                "cuda" will be used if available, otherwise "cpu".

            manual_seed (int): Optionally supplies the manual seed
                to use for the model.  If None, a random seed will
                be used.

            torch_profile_activities (list): Optionally supplies a
                list of torch.profiler.ProfilerActivity to profile.
...
3. Can we load OpenAI's GPT-2 XL?

4. Copying tensors in parallel.
...
https://github.com/tpn/website/blob/main/blog/posts/2025-xx-xx-pytorch-and-python-free-threading/run-py313t-gpt2-compile-tests.sh),
...
https://github.com/tpn/website/tree/main/blog/posts/2025-xx-xx-pytorch-and-python-free-threading/json)
directory.

Using [`gpt2-rates-2025-02-09-18-19-29-116321-py313t.json`](
https://github.com/tpn/website/blob/main/blog/posts/2025-xx-xx-pytorch-and-python-free-threading/json/gpt2-rates-2025-02-09-18-19-29-116321-py313t.json)
as an example:
...
full-blown old-school normal Python with no knowledge of GIL remove---i.e.
...
Charts pretty.  Post long.  Hope enjoyed.  Free-threaded Python go
brrrrrrt.  kthnxbai.
